...
public interface ATWeKittens {
    ...
    @Async
    void sendTuple(int cardId, int from, int to, int roundNb, boolean personal, List<Integer> deck, List<Integer> states, Integer additionalInformation, Integer nopeCardId);
